...
var ModeControl = Mode{Slug: "control", Title: "Herdr Plus · Control · Projects"}
...
// orderedModes lists every mode herdr-plus knows about, in a stable order. The
// modes lookup table is derived from it (so the two can never drift apart), and
// the herdr-plugin.toml manifest exposes one [[actions]] entry per mode. Add new
// modes here.
